                    ...
                    <div color="flex  items-center justify-center">
                        <div className="flex space-x-10 justify-center items-center flex-col space-y-5 sm:flex-row">
                            ...
                            <div className="flex flex-col gap-2">
                                <ReadOnlyText label="Họ và tên" value={localState.name} />
                                <ReadOnlyText label="Ngày đảm nhiệm" value={localState.date} />
                                <ReadOnlyText label="Chức vụ" value={localState.position} />
                                <ReadOnlyText label="Số điện thoại" value={localState.phone} />
                                <ReadOnlyText label="Email" value={localState.email} />
                            </div>
                        </div>
