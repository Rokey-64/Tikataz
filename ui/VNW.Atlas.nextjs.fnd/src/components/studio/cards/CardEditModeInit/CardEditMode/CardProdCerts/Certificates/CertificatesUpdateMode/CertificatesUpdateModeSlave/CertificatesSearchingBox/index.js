...
import CertificatesSearchingResultDisplay from "./CertificatesSearchingResultDisplay";

const CertificatesSeachingBox = ({ certificates, setFormData}) => {
    ...
    return (
        <div className="relative">
            ...
            <CertificatesSearchingResultDisplay searchCerts={searchCerts} searchTerm={searchTerm} isFocused={isFocused} callback={displayCallback}/>
        </div>
    );
};

export default CertificatesSeachingBox;