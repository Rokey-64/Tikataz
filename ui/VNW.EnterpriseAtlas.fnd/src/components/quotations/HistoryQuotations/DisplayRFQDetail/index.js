...
import { headerTemplate, itemTemplate, initialState, quotationDataReducer } from '../../../../reducers/quotationDataReducer';
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            if (response) {
                ...
                // console.log("orderBillData", orderBillData);
