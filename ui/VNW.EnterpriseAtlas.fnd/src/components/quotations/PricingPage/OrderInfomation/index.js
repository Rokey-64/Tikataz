        ...
        <div className="p-3 space-y-3">
            ...
            <div className='flex items-start justify-start mt-3 space-x-2 opacity-90 hover:opacity-100'>
                <div className='space-y-3 min-w-[300px]'>
                    <OrderInput title={t("order_name")} type="text" value={orderGeneral.orderName} onChange={onChange.bind(this, "orderName")} />
                ...
                <div className='space-y-3 min-w-[300px]'>
                    <OrderTextArea title={t("order_address")} value={orderGeneral.orderAddress} onChange={onChange.bind(this, "orderAddress")} />
                    <OrderTextArea title={t("order_remark")} value={orderGeneral.orderRemark} onChange={onChange.bind(this, "orderRemark")} />
                </div>
            </div>
        </div>
    );
