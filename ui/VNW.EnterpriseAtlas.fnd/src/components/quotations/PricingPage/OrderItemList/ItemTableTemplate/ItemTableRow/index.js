...
const ItemTableRow = ({ hashtagEvent, providerEvent, itemID, pos }) => {
    ...
    return (
        ...
        <div className="flex text-sm text-gray-800 ">
            ...
            <ItemTableCell type="body" width="w-[18rem]" pos="justify-center items-start">
            ...
            <ItemTableCell type="body" width="w-36" pos="justify-center items-center pt-4">
                <div className="min-w-[130px] text-start">
                    <CellInputBox title="Quy cách" value={item.specification} type="text" onChange={inputOnChange.bind(this, "specification")} />
                </div>
            </ItemTableCell>
            <ItemTableCell type="body" width="w-32" pos="justify-center items-center pt-4">
                <div className="min-w-[50px] text-start">
                    <CellInputBox title="Số lượng" value={item.unit} type="number" onChange={inputOnChange.bind(this, "quantity")} />
                </div>
            </ItemTableCell>
            <ItemTableCell type="body" width="w-28" pos="justify-center items-center pt-4">
                <div className="min-w-[50px] text-start">
                    <CellInputBox title="Đơn vị" value={item.unit} type="text" onChange={inputOnChange.bind(this, "unit")} />
                </div>
            </ItemTableCell>
            <ItemTableCell type="body" width="w-[16rem]" pos="justify-start items-center">
                <div>
                    <div className="min-w-[245px] text-start">
                        <CellInputBox title="Mô tả" value={item.description} type="text" onChange={inputOnChange.bind(this, "description")} />
                    </div>
