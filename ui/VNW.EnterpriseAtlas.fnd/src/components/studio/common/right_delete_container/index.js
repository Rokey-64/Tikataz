...
import RightChildrenBox from "../right_children_box";
...
const RightDeleteContainer = ({ headerContent, children, state, setState, callback = null}) => {
    ...
    return (
        <div className="absolute top-1 right-1 w-fit max-w-[480px] shadow-xl z-50 bg-[#eaf3fa]">
            <div >
                ...
                <RightChildrenBox children={
                    <>
                        ...
                        <div className="mt-3 mb-2">
                            <p className="px-4 my-3 text-sm font-semibold">Danh sách đối tượng được xóa:</p>
                            <hr />
                        </div>
