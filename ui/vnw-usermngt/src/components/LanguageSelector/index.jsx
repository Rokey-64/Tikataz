...
const LanguageSelector = () => {
  ...
  // Khởi tạo ngôn ngữ từ cookie khi component mount
  useEffect(() => {
  ...
  const changeLanguage = (language) => {
    ...
    document.cookie = `next-intl=${language}; path=/; domain=.tikataz.com; SameSite=Lax; expires=${expires}`;
  };

  const currentLangData = languages.find(lang => lang.code === currentLanguage);

  return (
    <div className="fixed bottom-4 right-4 z-50">  {/* Thêm `right-4` để tránh sát viền */}
      <div className="relative group">
        ...
        {/* Menu hiển thị phía trên (thêm `bottom-full` và `mb-2`) */}
